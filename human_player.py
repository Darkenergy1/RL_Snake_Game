...
# for counting score after eating fruit, and spawning/generating new fruit at a random point
# within 0,0 to 500,500 pixels
def collision_with_apple(apple_position, score):
    apple_position = [random.randrange(1, 50) * 10, random.randrange(1, 50) * 10]
    score += 1
    return apple_position, score

# return 1 if snake head (x,y) collide with boundries
...
#snake position contains Xs,Ys of all segments on a snake, initally snake starts with 3 segments
# return 1 on collisio with self
